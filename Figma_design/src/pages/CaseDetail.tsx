          ...
          <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
            ...
            <div className="p-6 border-b border-gray-200">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                  <h1 className="text-2xl font-semibold text-gray-900">{caseData.jmeno}</h1>
                  {caseData.isActive && (
              ...
              <div className="mt-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
                <div className="flex items-center justify-between mb-3">
                  <h3 className="text-sm font-semibold text-gray-900">Údaje o úvěru</h3>
                  {!isEditingLoanData && (
                    <button
                      onClick={() => setIsEditingLoanData(true)}
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs bg-white border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors"
                    >
                ...
                {isEditingLoanData ? (
                  <div className="space-y-3">
                    <div className="grid grid-cols-3 gap-3">
                      <div>
                        <label htmlFor="vyseUveru" className="block text-xs font-medium text-gray-700 mb-1">
                          Výše úvěru (Kč)
                        </label>
                        <input
                          id="vyseUveru"
                      ...
                      <div className="col-span-2">
                        <label htmlFor="ucel" className="block text-xs font-medium text-gray-700 mb-1">
                          Účel úvěru
                        </label>
                        <input
                          id="ucel"
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div>
                      <p className="text-xs text-gray-500 mb-1">Výše úvěru</p>
                      <p className="text-sm font-semibold text-gray-700">
                        {vyseUveru ? formatCurrency(parseInt(vyseUveru)) : <span className="text-gray-400">Neuvedeno</span>}
                      </p>
                    </div>
                    <div className="col-span-2">
                      <p className="text-xs text-gray-500 mb-1">Účel úvěru</p>
                      <p className="text-sm font-medium text-gray-700">
                        {ucel || <span className="text-gray-400">Neuvedeno</span>}
                      </p>
                    </div>
                  </div>
                )}
                ...
                <div className="mt-6 p-4 bg-white border border-gray-200 rounded-lg">
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-medium text-gray-700">Žadatelé ({caseData.applicants?.length || 0})</span>
                    </div>
            ...
            <div className="p-6">
              ...
              {activeTab === 'zakladni' && (() => {
                ...
                return (
                  <div className="space-y-6">
                    ...
                    <div>
                      <h2 className="text-lg font-semibold text-gray-900 mb-4">Osobní údaje žadatele</h2>
                      ...
                      {activeData ? (
                        <div className="grid grid-cols-2 gap-4">
                          ...
                          <div>
                            ...
                            <div className="px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg text-gray-900 font-mono">
                              {activeData.rc}
                            </div>
                          </div>
                          ...
                          <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">Národnost</label>
                            <div className="px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg text-gray-900">
                              {activeData.narodnost || <span className="text-gray-400">Neuvedeno</span>}
                            </div>
                          </div>
                          
                          {activeData.rodinnyStav && (
                            <div>
                              <label className="block text-sm font-medium text-gray-700 mb-1">Rodinný stav</label>
                              <div className="px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg text-gray-900">
                                {activeData.rodinnyStav}
                              </div>
                            </div>
                        ...
                        <div className="text-center py-12 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300">
                          ...
                          <p className="text-gray-500 text-sm">Základní údaje nejsou k dispozici</p>
                        </div>
                      )}
                    </div>
              ...
              {activeTab === 'op' && (() => {
                ...
                return (
                  <div>
                    <h2 className="text-lg font-semibold text-gray-900 mb-4">Údaje o občanském průkazu</h2>
                    ...
                    {activeData ? (
                      <div>
                        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            <h3 className="font-semibold text-blue-900">Informace o dokladu totožnosti</h3>
                          </div>
                          <p className="text-sm text-blue-800">Automaticky vytaženo z nahraných skenů OP</p>
                        </div>
                        ...
                        {(activeData.cisloDokladu || activeData.datumVydani || activeData.platnostDo || activeData.vydavajiciUrad) ? (
                          <div className="space-y-4">
                            ...
                            {activeData.vydavajiciUrad && (
                              <div>
                                <label className="block text-sm font-medium text-gray-700 mb-1">Vydávající úřad</label>
                                <div className="px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg text-gray-900">
                                  {activeData.vydavajiciUrad}
                                </div>
                              </div>
                          ...
                          <div className="text-center py-12 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300">
                            <UserCircle className="w-12 h-12 text-gray-400 mx-auto mb-3" />
                            <p className="text-gray-500 text-sm">Údaje o dokladu nejsou k dispozici</p>
                          </div>
                        )}
                      </div>
                    ) : (
                      <div className="text-center py-12 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300">
                        <UserCircle className="w-12 h-12 text-gray-400 mx-auto mb-3" />
                        <p className="text-gray-500 text-sm">Data z OP nejsou k dispozici</p>
                      </div>
                    )}
                  </div>
                );
              ...
              {activeTab === 'dp' && (() => {
                ...
                return (
                  <div>
                    <h2 className="text-lg font-semibold text-gray-900 mb-4">Data z daňového přiznání</h2>
                    ...
                    {activeTaxData ? (
                      <div className="space-y-6">
                        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            <h3 className="font-semibold text-blue-900">Daňové přiznání za rok {activeTaxData.rok}</h3>
                          </div>
                          <p className="text-sm text-blue-800">Automaticky vytaženo z nahraných dokumentů</p>
                        </div>
                            ...
                            <div className="space-y-3">
                              {activeTaxData.ic && (
                                <div className="flex justify-between items-center py-2 hover:bg-gray-50 rounded px-2 -mx-2">
                                  <span className="text-sm text-gray-600">IČ (identifikační číslo)</span>
                                  <span className="text-sm font-medium text-gray-900">{activeTaxData.ic}</span>
                                </div>
                              )}
                              
                              {activeTaxData.dic && (
                                <div className="flex justify-between items-center py-2 hover:bg-gray-50 rounded px-2 -mx-2">
                                  <span className="text-sm text-gray-600">DIČ (daňové identifikační číslo)</span>
                                  <span className="text-sm font-medium text-gray-900">{activeTaxData.dic}</span>
                                </div>
                              )}
                              
                              {activeTaxData.czNace && (
                                <div className="flex justify-between items-start py-2 hover:bg-gray-50 rounded px-2 -mx-2">
                                  <span className="text-sm text-gray-600">Převažující CZ-NACE</span>
                                  <span className="text-sm font-medium text-gray-900 text-right max-w-md">{activeTaxData.czNace}</span>
                                </div>
                              )}
                              
                              {activeTaxData.zpusobUplatneniVydaju && (
                                <div className="flex justify-between items-center py-2 hover:bg-gray-50 rounded px-2 -mx-2">
                                  <span className="text-sm text-gray-600">Způsob uplatnění výdajů</span>
                        ...
                        <div className="bg-white border border-gray-200 rounded-lg p-5">
                          <div className="flex items-center justify-between mb-4 pb-2 border-b border-gray-200">
                            ...
                            <button
                              ...
                              className="inline-flex items-center gap-2 px-3 py-1.5 text-xs bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg transition-colors"
                      ...
                      <div className="text-center py-12 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300">
                        ...
                        <p className="text-gray-500 text-sm">Daňové přiznání nebylo nahráno nebo zpracováno</p>
                      </div>
                    )}
                  </div>
                );
