      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="border-b border-gray-300">
            <th className="px-3 py-2 text-left text-xs font-medium text-gray-600 bg-gray-50 w-16">Ř</th>
            <th className="px-3 py-2 text-left text-xs font-medium text-gray-600 bg-gray-50">Položka</th>
            <th className="px-3 py-2 text-right text-xs font-medium text-gray-600 bg-gray-50 w-32">Hodnota</th>
          </tr>
        </thead>
        <tbody>
