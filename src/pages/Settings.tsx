    ...
    <div className="flex-1 bg-gray-50 app-content-dark overflow-auto">
      <div className="max-w-5xl mx-auto p-4 sm:p-6 lg:p-8">
        ...
        <div className="space-y-6">
          ...
          {/* Excelové kalkulačky RB / UCB – nahrání na server (per uživatel) */}
          <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-6">
              Nahrajte soubory .xlsm nebo .xlsx pro Raiffeisenbank a UniCredit Bank. Ukládají se k vašemu účtu na serveru
              a používají se v detailu případu v záložce „Bank. kalkulačky“. Bez běžícího API (např.{' '}
              <code className="text-xs bg-gray-100 dark:bg-gray-700 px-1 rounded">npm run dev:all</code>) nahrání nefunguje.
            </p>
